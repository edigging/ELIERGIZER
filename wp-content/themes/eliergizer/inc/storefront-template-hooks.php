...
add_action( 'storefront_footer', 'storefront_footer_widgets', 15 );
...
add_action( 'storefront_loop_post', 'storefront_post_content', 10 );
add_action( 'storefront_loop_post', 'storefront_init_structured_data', 20 );
